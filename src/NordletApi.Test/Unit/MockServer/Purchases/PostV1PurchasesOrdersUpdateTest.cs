...
public class PostV1PurchasesOrdersUpdateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/purchases/orders/update")
        ...
        var response = await Client.Purchases.PostV1PurchasesOrdersUpdateAsync(
