...
public class PostV1PurchasesOrdersSubmitTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response = await Client.Purchases.PostV1PurchasesOrdersSubmitAsync(
            new PostV1PurchasesOrdersSubmitRequest { Id = "x", Reason = null }
        );
