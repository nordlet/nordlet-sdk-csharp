...
public class PostV1TransportWaybillsIssueTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/transport/waybills/issue")
        ...
        var response = await Client.Transport.PostV1TransportWaybillsIssueAsync(
            new PostV1TransportWaybillsIssueRequest { Id = "x" }
        );
