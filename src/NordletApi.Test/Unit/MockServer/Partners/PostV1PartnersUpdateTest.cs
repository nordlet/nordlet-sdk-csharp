...
public class PostV1PartnersUpdateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response = await Client.Partners.PostV1PartnersUpdateAsync(
    ...
    public async Task MockServerTest_2()
    {
        ...
        var response = await Client.Partners.PostV1PartnersUpdateAsync(
            new PostV1PartnersUpdateRequest { Id = "id" }
        );
        JsonAssert.AreEqual(response, mockResponse);
    }
}
