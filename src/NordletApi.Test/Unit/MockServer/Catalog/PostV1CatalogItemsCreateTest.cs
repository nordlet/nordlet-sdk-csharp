...
public class PostV1CatalogItemsCreateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/catalog/items/create")
        ...
        var response = await Client.Catalog.PostV1CatalogItemsCreateAsync(
