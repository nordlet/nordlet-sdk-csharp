...
public class PostV1CatalogItemsKindsCreateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/catalog/items/kinds/create")
        ...
        var response = await Client.Catalog.PostV1CatalogItemsKindsCreateAsync(
