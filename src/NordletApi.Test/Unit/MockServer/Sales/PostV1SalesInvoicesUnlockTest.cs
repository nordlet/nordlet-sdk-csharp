...
public class PostV1SalesInvoicesUnlockTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/sales/invoices/unlock")
        ...
        var response = await Client.Sales.PostV1SalesInvoicesUnlockAsync(
            new PostV1SalesInvoicesUnlockRequest { Id = "x" }
        );
