...
public class PostV1SalesInvoicesUpdateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/v1/sales/invoices/update")
        ...
        var response = await Client.Sales.PostV1SalesInvoicesUpdateAsync(
