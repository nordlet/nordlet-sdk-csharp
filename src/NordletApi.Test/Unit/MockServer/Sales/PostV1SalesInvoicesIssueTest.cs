...
public class PostV1SalesInvoicesIssueTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response = await Client.Sales.PostV1SalesInvoicesIssueAsync(
    ...
    public async Task MockServerTest_2()
    {
        ...
        var response = await Client.Sales.PostV1SalesInvoicesIssueAsync(
            new PostV1SalesInvoicesIssueRequest { Id = "id" }
        );
        JsonAssert.AreEqual(response, mockResponse);
    }
}
