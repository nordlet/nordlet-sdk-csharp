...
public class PostV1SalesActsUpdateTest : BaseMockServerTest
{
    ...
    public async Task MockServerTest_1()
    {
        ...
        var response = await Client.Sales.PostV1SalesActsUpdateAsync(
    ...
    public async Task MockServerTest_2()
    {
        ...
        var response = await Client.Sales.PostV1SalesActsUpdateAsync(
            new PostV1SalesActsUpdateRequest { Id = "id" }
        );
        JsonAssert.AreEqual(response, mockResponse);
    }
}
