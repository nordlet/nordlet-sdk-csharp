...
[Serializable]
public record PostV1BankSettlementsPostResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankSettlementsPostResponseStatus Status { get; set; }
    ...
    public required PostV1BankSettlementsPostResponseSummary Summary { get; set; }
