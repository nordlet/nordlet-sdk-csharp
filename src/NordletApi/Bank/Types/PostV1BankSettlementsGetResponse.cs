...
[Serializable]
public record PostV1BankSettlementsGetResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankSettlementsGetResponseStatus Status { get; set; }
    ...
    public IEnumerable<PostV1BankSettlementsGetResponseLinesItem> Lines { get; set; } =
        new List<PostV1BankSettlementsGetResponseLinesItem>();
