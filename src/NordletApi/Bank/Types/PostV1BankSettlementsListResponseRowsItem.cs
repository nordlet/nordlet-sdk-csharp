...
[Serializable]
public record PostV1BankSettlementsListResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankSettlementsListResponseRowsItemStatus Status { get; set; }
