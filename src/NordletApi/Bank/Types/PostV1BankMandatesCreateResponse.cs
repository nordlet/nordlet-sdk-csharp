...
[Serializable]
public record PostV1BankMandatesCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankMandatesCreateResponseScheme Scheme { get; set; }

    [JsonPropertyName("sequenceType")]
    public required PostV1BankMandatesCreateResponseSequenceType SequenceType { get; set; }

    [JsonPropertyName("status")]
    public required PostV1BankMandatesCreateResponseStatus Status { get; set; }
