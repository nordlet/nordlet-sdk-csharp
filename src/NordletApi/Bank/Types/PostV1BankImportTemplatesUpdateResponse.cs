...
[Serializable]
public record PostV1BankImportTemplatesUpdateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankImportTemplatesUpdateResponseType Type { get; set; }

    [JsonPropertyName("fields")]
    public IEnumerable<PostV1BankImportTemplatesUpdateResponseFieldsItem> Fields { get; set; } =
        new List<PostV1BankImportTemplatesUpdateResponseFieldsItem>();
