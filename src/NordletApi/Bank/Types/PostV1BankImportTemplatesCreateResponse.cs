...
[Serializable]
public record PostV1BankImportTemplatesCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankImportTemplatesCreateResponseType Type { get; set; }

    [JsonPropertyName("fields")]
    public IEnumerable<PostV1BankImportTemplatesCreateResponseFieldsItem> Fields { get; set; } =
        new List<PostV1BankImportTemplatesCreateResponseFieldsItem>();
