...
[Serializable]
public record PostV1BankMandatesGetResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankMandatesGetResponseScheme Scheme { get; set; }

    [JsonPropertyName("sequenceType")]
    public required PostV1BankMandatesGetResponseSequenceType SequenceType { get; set; }

    [JsonPropertyName("status")]
    public required PostV1BankMandatesGetResponseStatus Status { get; set; }
