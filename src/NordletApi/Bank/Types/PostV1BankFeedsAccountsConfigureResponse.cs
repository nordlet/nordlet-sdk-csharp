...
[Serializable]
public record PostV1BankFeedsAccountsConfigureResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankFeedsAccountsConfigureResponseSyncSchedule SyncSchedule { get; set; }
