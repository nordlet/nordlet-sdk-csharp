...
[Serializable]
public record PostV1BankMandatesListResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankMandatesListResponseRowsItemScheme Scheme { get; set; }

    [JsonPropertyName("sequenceType")]
    public required PostV1BankMandatesListResponseRowsItemSequenceType SequenceType { get; set; }

    [JsonPropertyName("status")]
    public required PostV1BankMandatesListResponseRowsItemStatus Status { get; set; }
