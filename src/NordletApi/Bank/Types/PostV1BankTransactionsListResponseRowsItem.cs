...
[Serializable]
public record PostV1BankTransactionsListResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankTransactionsListResponseRowsItemStatus Status { get; set; }
