...
[Serializable]
public record PostV1BankFeedsConnectionsGetResponseAccountsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankFeedsConnectionsGetResponseAccountsItemSyncSchedule SyncSchedule { get; set; }
