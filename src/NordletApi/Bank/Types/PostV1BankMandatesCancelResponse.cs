...
[Serializable]
public record PostV1BankMandatesCancelResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1BankMandatesCancelResponseScheme Scheme { get; set; }

    [JsonPropertyName("sequenceType")]
    public required PostV1BankMandatesCancelResponseSequenceType SequenceType { get; set; }

    [JsonPropertyName("status")]
    public required PostV1BankMandatesCancelResponseStatus Status { get; set; }
