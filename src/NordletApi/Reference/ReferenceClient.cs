...
public partial class ReferenceClient : IReferenceClient
{
    ...
    private async Task<
        WithRawResponse<PostV1ReferenceEuVatRatesImportsListResponse>
    > PostV1ReferenceEuVatRatesImportsListAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            {
                var responseData =
                    JsonUtils.Deserialize<PostV1ReferenceEuVatRatesImportsListResponse>(
                        responseBody
                    )!;
                return new WithRawResponse<PostV1ReferenceEuVatRatesImportsListResponse>()
                {
                    Data = responseData,
                    RawResponse = new NordletApi.RawResponse()
                    {
    ...
    private async Task<
        WithRawResponse<PostV1ReferenceEuVatRatesSyncResponse>
    > PostV1ReferenceEuVatRatesSyncAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<PostV1ReferenceEuVatRatesSyncResponse>(
                    responseBody
                )!;
                return new WithRawResponse<PostV1ReferenceEuVatRatesSyncResponse>()
                {
                    Data = responseData,
                    RawResponse = new NordletApi.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<PostV1ReferenceEuVatRatesImportsListResponse> PostV1ReferenceEuVatRatesImportsListAsync(
        PostV1ReferenceEuVatRatesImportsListRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<PostV1ReferenceEuVatRatesImportsListResponse>(
            PostV1ReferenceEuVatRatesImportsListAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<PostV1ReferenceEuVatRatesSyncResponse> PostV1ReferenceEuVatRatesSyncAsync(
        PostV1ReferenceEuVatRatesSyncRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<PostV1ReferenceEuVatRatesSyncResponse>(
            PostV1ReferenceEuVatRatesSyncAsyncCore(request, options, cancellationToken)
        );
    }
