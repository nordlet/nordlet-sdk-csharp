...
[Serializable]
public record PostV1PartnersGetResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1PartnersGetResponseType Type { get; set; }
    ...
    public PostV1PartnersGetResponseAddress? Address { get; set; }

    [JsonPropertyName("correspondenceAddress")]
    public PostV1PartnersGetResponseCorrespondenceAddress? CorrespondenceAddress { get; set; }
    ...
    public PostV1PartnersGetResponseLegalCountryClass? LegalCountryClass { get; set; }
