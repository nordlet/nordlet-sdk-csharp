...
[Serializable]
public record PostV1PartnersFindOrCreateResponsePartner : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1PartnersFindOrCreateResponsePartnerType Type { get; set; }
    ...
    public PostV1PartnersFindOrCreateResponsePartnerAddress? Address { get; set; }

    [JsonPropertyName("correspondenceAddress")]
    public PostV1PartnersFindOrCreateResponsePartnerCorrespondenceAddress? CorrespondenceAddress { get; set; }
    ...
    public PostV1PartnersFindOrCreateResponsePartnerLegalCountryClass? LegalCountryClass { get; set; }
