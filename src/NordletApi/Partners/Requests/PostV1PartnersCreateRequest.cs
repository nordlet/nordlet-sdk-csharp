...
public record PostV1PartnersCreateRequest
{
    ...
    public PostV1PartnersCreateRequestCorrespondenceAddress? CorrespondenceAddress { get; set; }
    ...
    public PostV1PartnersCreateRequestLegalCountryClass? LegalCountryClass { get; set; }
