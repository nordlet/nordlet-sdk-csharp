...
[Serializable]
public record PostV1PartnersFindOrCreateRequest
{
    [JsonPropertyName("type")]
    public PostV1PartnersFindOrCreateRequestType? Type { get; set; }
    ...
    public PostV1PartnersFindOrCreateRequestAddress? Address { get; set; }

    [JsonPropertyName("correspondenceAddress")]
    public PostV1PartnersFindOrCreateRequestCorrespondenceAddress? CorrespondenceAddress { get; set; }
    ...
    public PostV1PartnersFindOrCreateRequestLegalCountryClass? LegalCountryClass { get; set; }
