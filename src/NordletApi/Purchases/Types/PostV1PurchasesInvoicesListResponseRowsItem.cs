...
[Serializable]
public record PostV1PurchasesInvoicesListResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1PurchasesInvoicesListResponseRowsItemType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1PurchasesInvoicesListResponseRowsItemStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1PurchasesInvoicesListResponseRowsItemPaymentStatus PaymentStatus { get; set; }
