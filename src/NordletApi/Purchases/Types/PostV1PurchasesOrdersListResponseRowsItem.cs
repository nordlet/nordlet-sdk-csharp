...
[Serializable]
public record PostV1PurchasesOrdersListResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1PurchasesOrdersListResponseRowsItemStatus Status { get; set; }
