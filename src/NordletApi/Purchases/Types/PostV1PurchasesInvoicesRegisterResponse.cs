...
[Serializable]
public record PostV1PurchasesInvoicesRegisterResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1PurchasesInvoicesRegisterResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1PurchasesInvoicesRegisterResponseStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1PurchasesInvoicesRegisterResponsePaymentStatus PaymentStatus { get; set; }
    ...
    public IEnumerable<PostV1PurchasesInvoicesRegisterResponseLinesItem> Lines { get; set; } =
        new List<PostV1PurchasesInvoicesRegisterResponseLinesItem>();
