...
[Serializable]
public record PostV1PurchasesInvoicesGetResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1PurchasesInvoicesGetResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1PurchasesInvoicesGetResponseStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1PurchasesInvoicesGetResponsePaymentStatus PaymentStatus { get; set; }
    ...
    public IEnumerable<PostV1PurchasesInvoicesGetResponseLinesItem> Lines { get; set; } =
        new List<PostV1PurchasesInvoicesGetResponseLinesItem>();
