...
[Serializable]
public record PostV1PurchasesInvoicesCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1PurchasesInvoicesCreateResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1PurchasesInvoicesCreateResponseStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1PurchasesInvoicesCreateResponsePaymentStatus PaymentStatus { get; set; }
    ...
    public IEnumerable<PostV1PurchasesInvoicesCreateResponseLinesItem> Lines { get; set; } =
        new List<PostV1PurchasesInvoicesCreateResponseLinesItem>();
