...
[Serializable]
public record PostV1PosReportsCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<PostV1PosReportsCreateResponseVatLinesItem> VatLines { get; set; } =
        new List<PostV1PosReportsCreateResponseVatLinesItem>();
