...
[Serializable]
public record PostV1PosReportsGetResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<PostV1PosReportsGetResponseVatLinesItem> VatLines { get; set; } =
        new List<PostV1PosReportsGetResponseVatLinesItem>();
