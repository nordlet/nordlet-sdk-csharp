...
[Serializable]
public record PostV1DeclarationsEuOssComputeResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1DeclarationsEuOssComputeResponseRowsItemRateType RateType { get; set; }
