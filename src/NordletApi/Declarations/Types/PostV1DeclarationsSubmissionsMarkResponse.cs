...
[Serializable]
public record PostV1DeclarationsSubmissionsMarkResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1DeclarationsSubmissionsMarkResponseStatus Status { get; set; }
