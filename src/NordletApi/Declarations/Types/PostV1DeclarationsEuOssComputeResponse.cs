...
[Serializable]
public record PostV1DeclarationsEuOssComputeResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<PostV1DeclarationsEuOssComputeResponseRowsItem> Rows { get; set; } =
        new List<PostV1DeclarationsEuOssComputeResponseRowsItem>();
