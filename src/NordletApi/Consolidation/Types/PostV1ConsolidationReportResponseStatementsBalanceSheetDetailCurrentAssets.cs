...
[Serializable]
public record PostV1ConsolidationReportResponseStatementsBalanceSheetDetailCurrentAssets
    : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    [JsonPropertyName("otherCurrent")]
    public required string OtherCurrent { get; set; }
