...
[Serializable]
public record PostV1TransportWaybillsCreateRequest
{
    ...
    public required DateTime DispatchAt { get; set; }
    ...
    public IEnumerable<PostV1TransportWaybillsCreateRequestLinesItem>? Lines { get; set; }
