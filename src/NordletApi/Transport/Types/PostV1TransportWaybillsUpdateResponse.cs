...
[Serializable]
public record PostV1TransportWaybillsUpdateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1TransportWaybillsUpdateResponseStatus Status { get; set; }
    ...
    public IEnumerable<PostV1TransportWaybillsUpdateResponseLinesItem> Lines { get; set; } =
        new List<PostV1TransportWaybillsUpdateResponseLinesItem>();
