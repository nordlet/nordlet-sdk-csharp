...
[Serializable]
public record PostV1TransportWaybillsCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1TransportWaybillsCreateResponseStatus Status { get; set; }
    ...
    public IEnumerable<PostV1TransportWaybillsCreateResponseLinesItem> Lines { get; set; } =
        new List<PostV1TransportWaybillsCreateResponseLinesItem>();
