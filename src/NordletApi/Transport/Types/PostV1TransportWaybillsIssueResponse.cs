...
[Serializable]
public record PostV1TransportWaybillsIssueResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1TransportWaybillsIssueResponseStatus Status { get; set; }
    ...
    public IEnumerable<PostV1TransportWaybillsIssueResponseLinesItem> Lines { get; set; } =
        new List<PostV1TransportWaybillsIssueResponseLinesItem>();
