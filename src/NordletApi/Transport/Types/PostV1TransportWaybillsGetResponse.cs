...
[Serializable]
public record PostV1TransportWaybillsGetResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1TransportWaybillsGetResponseStatus Status { get; set; }
    ...
    public IEnumerable<PostV1TransportWaybillsGetResponseLinesItem> Lines { get; set; } =
        new List<PostV1TransportWaybillsGetResponseLinesItem>();
