...
[Serializable]
public record PostV1AssetsAssetsCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1AssetsAssetsCreateResponseStatus Status { get; set; }

    [JsonPropertyName("notes")]
    public string? Notes { get; set; }

    [JsonPropertyName("documents")]
    public IEnumerable<PostV1AssetsAssetsCreateResponseDocumentsItem>? Documents { get; set; }
