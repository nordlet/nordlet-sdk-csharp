...
[Serializable]
public record PostV1PayrollRunsCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<PostV1PayrollRunsCreateResponseLinesItem> Lines { get; set; } =
        new List<PostV1PayrollRunsCreateResponseLinesItem>();
