...
[Serializable]
public record PostV1FleetVehiclesCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1FleetVehiclesCreateResponseStatus Status { get; set; }

    [JsonPropertyName("notes")]
    public string? Notes { get; set; }

    [JsonPropertyName("documents")]
    public IEnumerable<PostV1FleetVehiclesCreateResponseDocumentsItem>? Documents { get; set; }

    [JsonPropertyName("currentAssignment")]
    public PostV1FleetVehiclesCreateResponseCurrentAssignment? CurrentAssignment { get; set; }
