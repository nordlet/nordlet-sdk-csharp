...
[Serializable]
public record PostV1SalesInvoicesLockResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesInvoicesLockResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesInvoicesLockResponseStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1SalesInvoicesLockResponsePaymentStatus PaymentStatus { get; set; }
    ...
    public PostV1SalesInvoicesLockResponseVatScheme? VatScheme { get; set; }
    ...
    public IEnumerable<PostV1SalesInvoicesLockResponseLinesItem> Lines { get; set; } =
        new List<PostV1SalesInvoicesLockResponseLinesItem>();

    [JsonPropertyName("vatEvidence")]
    public PostV1SalesInvoicesLockResponseVatEvidence? VatEvidence { get; set; }
