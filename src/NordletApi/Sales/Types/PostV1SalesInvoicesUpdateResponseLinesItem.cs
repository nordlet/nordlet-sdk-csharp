...
[Serializable]
public record PostV1SalesInvoicesUpdateResponseLinesItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMethod RecognitionMethod { get; set; }
    ...
    public IEnumerable<PostV1SalesInvoicesUpdateResponseLinesItemRecognitionMilestonesItem>? RecognitionMilestones { get; set; }
