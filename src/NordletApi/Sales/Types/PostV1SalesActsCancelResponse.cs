...
[Serializable]
public record PostV1SalesActsCancelResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesActsCancelResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesActsCancelResponseStatus Status { get; set; }
