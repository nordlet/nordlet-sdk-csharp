...
[Serializable]
public record PostV1OperationTypesListResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public PostV1OperationTypesListResponseRowsItemInvoiceType? InvoiceType { get; set; }
