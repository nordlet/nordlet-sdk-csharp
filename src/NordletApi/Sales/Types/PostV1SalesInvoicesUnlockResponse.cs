...
[Serializable]
public record PostV1SalesInvoicesUnlockResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesInvoicesUnlockResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesInvoicesUnlockResponseStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1SalesInvoicesUnlockResponsePaymentStatus PaymentStatus { get; set; }
    ...
    public PostV1SalesInvoicesUnlockResponseVatScheme? VatScheme { get; set; }
    ...
    public IEnumerable<PostV1SalesInvoicesUnlockResponseLinesItem> Lines { get; set; } =
        new List<PostV1SalesInvoicesUnlockResponseLinesItem>();

    [JsonPropertyName("vatEvidence")]
    public PostV1SalesInvoicesUnlockResponseVatEvidence? VatEvidence { get; set; }
