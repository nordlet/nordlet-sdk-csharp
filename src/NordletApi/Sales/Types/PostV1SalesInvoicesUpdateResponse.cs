...
[Serializable]
public record PostV1SalesInvoicesUpdateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesInvoicesUpdateResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesInvoicesUpdateResponseStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1SalesInvoicesUpdateResponsePaymentStatus PaymentStatus { get; set; }
    ...
    public PostV1SalesInvoicesUpdateResponseVatScheme? VatScheme { get; set; }
