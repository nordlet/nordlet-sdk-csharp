...
[Serializable]
public record PostV1SalesActsListResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesActsListResponseRowsItemType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesActsListResponseRowsItemStatus Status { get; set; }
