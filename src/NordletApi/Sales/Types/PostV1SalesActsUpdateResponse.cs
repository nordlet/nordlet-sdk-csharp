...
[Serializable]
public record PostV1SalesActsUpdateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesActsUpdateResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesActsUpdateResponseStatus Status { get; set; }
    ...
    public IEnumerable<PostV1SalesActsUpdateResponseLinesItem> Lines { get; set; } =
        new List<PostV1SalesActsUpdateResponseLinesItem>();
