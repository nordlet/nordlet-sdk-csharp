...
[Serializable]
public record PostV1SalesInvoicesApplyAdvanceResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesInvoicesApplyAdvanceResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesInvoicesApplyAdvanceResponseStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1SalesInvoicesApplyAdvanceResponsePaymentStatus PaymentStatus { get; set; }
    ...
    public IEnumerable<PostV1SalesInvoicesApplyAdvanceResponseLinesItem> Lines { get; set; } =
        new List<PostV1SalesInvoicesApplyAdvanceResponseLinesItem>();

    [JsonPropertyName("vatEvidence")]
    public PostV1SalesInvoicesApplyAdvanceResponseVatEvidence? VatEvidence { get; set; }
