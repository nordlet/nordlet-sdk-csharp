...
[Serializable]
public record PostV1SalesActsGetResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesActsGetResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesActsGetResponseStatus Status { get; set; }
    ...
    public IEnumerable<PostV1SalesActsGetResponseLinesItem> Lines { get; set; } =
        new List<PostV1SalesActsGetResponseLinesItem>();
