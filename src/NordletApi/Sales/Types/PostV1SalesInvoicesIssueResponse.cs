...
[Serializable]
public record PostV1SalesInvoicesIssueResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesInvoicesIssueResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesInvoicesIssueResponseStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1SalesInvoicesIssueResponsePaymentStatus PaymentStatus { get; set; }
    ...
    public PostV1SalesInvoicesIssueResponseVatScheme? VatScheme { get; set; }
    ...
    public IEnumerable<PostV1SalesInvoicesIssueResponseLinesItem> Lines { get; set; } =
        new List<PostV1SalesInvoicesIssueResponseLinesItem>();

    [JsonPropertyName("vatEvidence")]
    public PostV1SalesInvoicesIssueResponseVatEvidence? VatEvidence { get; set; }
