...
[Serializable]
public record PostV1SalesInvoicesCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesInvoicesCreateResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesInvoicesCreateResponseStatus Status { get; set; }

    [JsonPropertyName("paymentStatus")]
    public required PostV1SalesInvoicesCreateResponsePaymentStatus PaymentStatus { get; set; }
    ...
    public PostV1SalesInvoicesCreateResponseVatScheme? VatScheme { get; set; }
    ...
    public IEnumerable<PostV1SalesInvoicesCreateResponseLinesItem> Lines { get; set; } =
        new List<PostV1SalesInvoicesCreateResponseLinesItem>();

    [JsonPropertyName("vatEvidence")]
    public PostV1SalesInvoicesCreateResponseVatEvidence? VatEvidence { get; set; }
