...
[Serializable]
public record PostV1SalesActsCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1SalesActsCreateResponseType Type { get; set; }

    [JsonPropertyName("status")]
    public required PostV1SalesActsCreateResponseStatus Status { get; set; }
    ...
    public IEnumerable<PostV1SalesActsCreateResponseLinesItem> Lines { get; set; } =
        new List<PostV1SalesActsCreateResponseLinesItem>();
