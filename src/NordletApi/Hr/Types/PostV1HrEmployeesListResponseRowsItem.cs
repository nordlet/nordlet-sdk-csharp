...
[Serializable]
public record PostV1HrEmployeesListResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public PostV1HrEmployeesListResponseRowsItemAddress? Address { get; set; }
    ...
    public required PostV1HrEmployeesListResponseRowsItemStatus Status { get; set; }

    [JsonPropertyName("notes")]
    public string? Notes { get; set; }

    [JsonPropertyName("attributes")]
    public IEnumerable<PostV1HrEmployeesListResponseRowsItemAttributesItem>? Attributes { get; set; }
