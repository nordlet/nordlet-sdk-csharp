...
[Serializable]
public record PostV1HrEmployeesGetResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public PostV1HrEmployeesGetResponseAddress? Address { get; set; }
    ...
    public required PostV1HrEmployeesGetResponseStatus Status { get; set; }
