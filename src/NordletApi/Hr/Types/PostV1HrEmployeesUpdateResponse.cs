...
[Serializable]
public record PostV1HrEmployeesUpdateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public PostV1HrEmployeesUpdateResponseAddress? Address { get; set; }
    ...
    public required PostV1HrEmployeesUpdateResponseStatus Status { get; set; }

    [JsonPropertyName("notes")]
    public string? Notes { get; set; }

    [JsonPropertyName("attributes")]
    public IEnumerable<PostV1HrEmployeesUpdateResponseAttributesItem>? Attributes { get; set; }
