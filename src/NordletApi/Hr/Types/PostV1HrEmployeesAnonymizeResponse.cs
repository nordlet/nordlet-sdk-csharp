...
[Serializable]
public record PostV1HrEmployeesAnonymizeResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public PostV1HrEmployeesAnonymizeResponseAddress? Address { get; set; }
    ...
    public required PostV1HrEmployeesAnonymizeResponseStatus Status { get; set; }
