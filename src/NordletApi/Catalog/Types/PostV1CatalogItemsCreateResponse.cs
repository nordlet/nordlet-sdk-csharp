...
[Serializable]
public record PostV1CatalogItemsCreateResponse : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1CatalogItemsCreateResponseType Type { get; set; }

    [JsonPropertyName("tracking")]
    public required PostV1CatalogItemsCreateResponseTracking Tracking { get; set; }
    ...
    public IEnumerable<PostV1CatalogItemsCreateResponseComponentsItem> Components { get; set; } =
        new List<PostV1CatalogItemsCreateResponseComponentsItem>();
