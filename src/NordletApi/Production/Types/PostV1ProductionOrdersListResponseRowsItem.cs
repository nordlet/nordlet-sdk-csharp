...
[Serializable]
public record PostV1ProductionOrdersListResponseRowsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required PostV1ProductionOrdersListResponseRowsItemType Type { get; set; }
