...
[Serializable]
public record PostV1ProductionRoutingsCreateRequestOperationsItem : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public string? SetupMinutes { get; set; }

    [JsonPropertyName("runMinutesPerUnit")]
    public string? RunMinutesPerUnit { get; set; }
